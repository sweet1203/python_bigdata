const faqs = [
  ...
  },
  {
    ...
    answer: "`학습하기` 페이지에서 차시를 선택한 뒤 교안의 코드 셀을 위에서부터 순서대로 실행하면 됩니다.",
  },
  {
    ...
    <section className="w-full space-y-4 rounded-xl border border-zinc-200 bg-white p-6">
      ...
      <div className="rounded-md border border-emerald-200 bg-emerald-50 px-4 py-3">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-emerald-900">
          ...
          <li>차시별 마크다운 교안을 웹에서 가독성 높은 형태로 학습할 수 있습니다.</li>
        </ul>
      </div>
      <div className="rounded-md border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-700">
        ...
        <p className="mt-1">
          수업 순서는 <span className="font-medium">학습하기 → 퀴즈 → 내 학습 현황</span>입니다. 데이터 파일은{" "}
